...
export const PeerComparisonTable = ({ 
  data, 
            ...
            <Table>
              ...
              <TableBody>
                {data.map((row, index) => {
                  ...
                  const displayPrice = livePrice?.price ?? row.price;
                  const displayChangePercent = livePrice?.changePercent ?? 0;
                    ...
                    >
                      ...
                      <TableCell className="text-right">
                        <span className={cn(
                          ...
                          displayChangePercent >= 0 ? "text-success" : "text-destructive"
                        )}>
