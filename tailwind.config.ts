...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "glow-sm": "0 0 20px -5px hsl(38 60% 50% / 0.15)",
        "glow-md": "0 0 40px -10px hsl(38 60% 50% / 0.2)",
        "glow-lg": "0 0 80px -20px hsl(38 60% 50% / 0.25)",
        "card": "0 4px 20px -4px hsl(220 20% 0% / 0.3)",
        "card-hover": "0 20px 50px -12px hsl(220 20% 0% / 0.5)",
      },
    },
  },
